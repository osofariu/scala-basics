...
class FizzBuzzSpec extends FlatSpec with Matchers {
  ...
  "fizz buzz" should "return Buzz every multiple of 5 for range 1 to 5" in {
    val fb = new FizzBuzz(1 to 5)
    fb.fizzBuzz() should be (List("1", "2", "FIZZ", "4", "BUZZ"))
  }

  "fizz buzz" should "return FizzBuzz every multiple of 3 and 5 for range 1 to 15" in {
    val fb = new FizzBuzz(1 to 15)
    fb.fizzBuzz() should be (List("1", "2", "FIZZ", "4", "BUZZ", "FIZZ", "7", "8", "FIZZ", "BUZZ", "11", "FIZZ", "13", "14", "FIZZBUZZ"))
  }
}
